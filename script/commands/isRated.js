...
module.exports.run = async function ({ api, event, args }) {
    ...
    try {
        ...
        if (responseData.dashboard && responseData.success) {
            ...
            api.editMessage("𝖫𝖾𝗏𝖾𝗅 𝗇𝗈𝗍 𝖿𝗈𝗎𝗇𝖽 𝗈𝗋 𝖺𝗇 𝖾𝗋𝗋𝗈𝗋 𝗈𝖼𝖼𝗎𝗋𝗋𝖾𝖽 𝗐𝗁𝗂𝗅𝖾 𝗉𝗋𝗈𝖼𝖾𝖾𝖽𝗂𝗇𝗀 𝗒𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍.", waitMessage.messageID, event.threadID);
        }
    } catch (error) {
        console.error(error);
